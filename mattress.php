                        ...
                        <div class="col-6 col-sm-4">
                            <div class="product-default">
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title"><a href="javascript:void(0)">Brown Women Casual HandBag</a>
                                    </h3>
                            ...
                            <div class="widget">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-body-2" role="button" aria-expanded="true"
                                       aria-controls="widget-body-2">FIRMNESS</a>
                                </h3>
                                <div class="collapse show" id="widget-body-2">
                                    <div class="widget-body">
                                        <ul class="cat-list">
                                            <li><a href="#">Soft</a></li>
                                            <li><a href="#">Medium Soft</a></li>
                                            <li><a href="#">Medium</a></li>
                                            <li><a href="#">Firm Medium</a></li>
                                            <li><a href="#">Firm</a></li>
                                            <li><a href="#">Super Firm</a></li>
                                        </ul>
                                    </div>
                                    <!-- End .widget-body -->
                                </div>
                            ...
                            <div class="widget">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-body-3" role="button" aria-expanded="true"
                                       aria-controls="widget-body-2">CONSTRUCTION</a>
                                </h3>
                                <div class="collapse show" id="widget-body-3">
                                    <div class="widget-body">
                                        <ul class="cat-list">
                                            <li><a href="#">Sprung</a></li>
                                            <li><a href="#">Pocket Sprung</a></li>
                                            <li><a href="#">Memory Foam</a></li>
                                            <li><a href="#">Natural Fillings</a></li>
                                            <li><a href="#">Gel</a></li>
                                            <li><a href="#">Sprung with foam top</a></li>
                                            <li><a href="#">Waterproof</a></li>
                                            <li><a href="#">Air Vents</a></li>
                                        </ul>
                                    </div>
                                    <!-- End .widget-body -->
                                </div>
