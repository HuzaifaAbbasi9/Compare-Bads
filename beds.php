        ...
        <div class="container">
            <div class="row">
                ...
                <aside class="sidebar-shop col-lg-3 order-lg-first mobile-sidebar">
                    <div class="pin-wrapper" style="height: 1212.51px;">
                        <div class="sidebar-wrapper"
                             style="border-bottom: 0px none rgb(119, 119, 119); width: 279.979px;">
                            <div class="widget">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-body-1" role="button" aria-expanded="true"
                                       aria-controls="widget-body-2">SIZES</a>
                                </h3>
                                <div class="collapse show" id="widget-body-1">
                                    <div class="widget-body">
                                        <ul class="cat-list">
                                            <li><a href="#">Cot</a></li>
                                            <li><a href="#">Small Single</a></li>
                                            <li><a href="#">Single</a></li>
                                            <li><a href="#">Double</a></li>
                                            <li><a href="#">Queen</a></li>
                                            <li><a href="#">Super</a></li>
                                            <li><a href="#">Super King</a></li>
                            ...
                            <div class="widget">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-body-2" role="button" aria-expanded="true"
                                       aria-controls="widget-body-2">STYLE</a>
                                </h3>
                                <div class="collapse show" id="widget-body-2">
                                    <div class="widget-body">
                                        <ul class="cat-list">
                                            <li><a href="#">Divan (Side or End Drawers)</a></li>
                                            <li><a href="#">Divan Ottoman (Lifting Storage)</a></li>
                                            <li><a href="#">Sleigh Beds (Flat Pack)</a></li>
                                            <li><a href="#">Sleigh Beds (Ottoman Lifting Style)</a></li>
                                            <li><a href="#">Round Beds</a></li>
                                            <li><a href="#">Bunk Beds</a></li>
                                            <li><a href="#">Car Beds</a></li>
                                            <li><a href="#">TV Beds</a></li>
                                            <li><a href="#">3 Sleepers</a></li>
                                            <li><a href="#">Princess Carriage</a></li>
                                            <li><a href="#">Ambassador Beds (Chunky Side Rails)</a></li>
                                        </ul>
                                    </div>
                                    <!-- End .widget-body -->
                                </div>
                            ...
                            <div class="widget">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-body-3" role="button" aria-expanded="true"
                                       aria-controls="widget-body-2">MATERIAL</a>
                                </h3>
                            ...
                            <div class="widget">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-body-4" role="button" aria-expanded="true"
                                       aria-controls="widget-body-2">STORAGE</a>
                                </h3>
                                <div class="collapse show" id="widget-body-4">
                                    <div class="widget-body">
                                        <ul class="cat-list">
                                            <li><a href="#">Side Drawers</a></li>
                                            <li><a href="#">End Drawers</a></li>
                                            <li><a href="#">Separate Storage Boxes</a></li>
                                        </ul>
                                    </div>
                                    <!-- End .widget-body -->
                                </div>
                            ...
                            <div class="widget">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-body-5" role="button" aria-expanded="true"
                                       aria-controls="widget-body-2">Color</a>
                                </h3>
                            ...
                            <div class="widget">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-body-6" role="button" aria-expanded="true"
                                       aria-controls="widget-body-2">Pattern</a>
                                </h3>
